...
<head>
    ...
    <style>
        ...
        /* Toast slide up */
        #dashboard-toast { transition: opacity 0.25s, transform 0.25s; }
        #dashboard-toast.show { opacity: 1; transform: translateY(0); }
        #dashboard-toast.hide { opacity: 0; transform: translateY(12px); pointer-events: none; }
    </style>
</head>
...
<body class="bg-slate-50 font-sans antialiased text-slate-900 min-h-screen">
    ...
    <script src="<?= $baseUrl ?>/assets/js/dashboard.js" defer></script>
</body>
</html>
